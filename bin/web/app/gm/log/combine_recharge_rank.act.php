<?php
class Act_Combine_recharge_rank extends Page{
	...
	public function process(){
		...
		$sql = "select * from {$this->dbh->dbname}.log_combine_recharge_rank";
	...
	{	
        ...
        echo "<script>alert('名字错误');window.location.href='?mod=log&act=combine_recharge_rank';</script>";
       //echo $url;
        exit;    
        }       
