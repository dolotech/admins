<?php
class Act_Recharge_activity1 extends Page{     
    ...
    public function __construct(){
        ...
        if(is_numeric($this->input['kw']['type'])) $this->type = $this->input['kw']['type'];
        $type_arr=array(
        		'0'=>'全部类型',
        		'1'=>'累计充值',
        		'2'=>'循环充值',
        ...
        $this->assign('type_select', Form::select('kw[type]', $type_arr, $this->type));
