...
class Act_Task_callback extends TencentTaskCallback{
    ...
    public function check_reward(){
        $tsid = $this->targetGameSid;
        $this->serverCfg = Config::getInstance($this->platformId.'_s'.$tsid);
        ...
        if($itemid == '') $itemid = '0';
        $lsid = $this->logicGameSid;
        $in .= "tencent_task|$lsid|$openid|$billno|$contractid|$step|$cmd|$itemid";
